...
| **POL\#5** | **Open Data:** Organizations should ensure that Earth observation data is discoverable, accessible and proactively made available for use, reuse and redistribution to users in human and machine readable form under an open license, refer **POL\#8**. The [open knowledge foundation's definition of open](https://okfn.org/en/library/what-is-open/) is to be used. |
